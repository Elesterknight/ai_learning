    ...
    def fit(self):
        ...
        for epoch in range(self.config.trainer.total_epochs):
            for batch_dict in self.train_dataloader:
                ...
                # gen_batch(有"input_ids", "attention_mask", "position_ids")，batch(沒有了"input_ids", "attention_mask", "position_ids")
                gen_batch = batch.pop(
                    batch_keys=batch_keys_to_pop,
                    non_tensor_batch_keys=non_tensor_batch_keys_to_pop,
                )
                ...
                with marked_timer("step", timing_raw):
                    ...
                    # generate a batch
                        with marked_timer("gen", timing_raw, color="red"):
                            ...
                            # gen_batch_output中prompt + response的input_ids， attention_mask， position_ids合併到batch中
                        ...
                        with marked_timer("gen", timing_raw, color="red"):
                            ...
                            with torch.no_grad():
                                ...
                                # 將log_prob合併到final_gen_batch_output
                            ...
                            # repeat to align with repeated responses in rollout
                            batch = batch.repeat(repeat_times=self.config.actor_rollout_ref.rollout.n, interleave=True)
                            # 將final_gen_batch_output中的prompt + response的input_ids， attention_mask， info_mask， position_ids， response的log_prob合併到batch
