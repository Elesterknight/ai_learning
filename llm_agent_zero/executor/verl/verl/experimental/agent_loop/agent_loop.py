...
class AgentLoopWorker:
    ...
    def __init__(self, config: DictConfig, server_handles: List[ray.actor.ActorHandle]):
        ...
        # 為了讓設定檔中指定的custom_chat_template生效
        if self.config.actor_rollout_ref.model.get("custom_chat_template", None):
    ...
    def get_agent_loop_class(self, agent_name: str) -> Type[AgentLoopBase]:
        ...
        from verl.experimental.agent_loop.tool_agent_loop import ToolAgentLoop, PythonAgentLoop
