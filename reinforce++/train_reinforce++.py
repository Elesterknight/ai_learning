        ...
        for update in range(1, args.num_total_batches + 1):
            ...
            with torch.no_grad():
                ...
                if args.token_level_kl:
                    ...
                    # ppo採用的方法，將獎勵歸因於最後一個token，最後一個token之前只有kl散度作為獎勵
                ...
                # 類似於grpo，使用一個組的平均獎勵計算baseline，同時去掉了std
                if args.use_baseline:
                ...
                # reinforce++會使用一個batch內的資料對優勢進行正規化
...
if __name__ == "__main__":
    ...
    training_args = ReinForcePlusPlusConfig(
        ...
        optim = "paged_adamw_32bit",# 可使用paged_adamw_8bit進一步降低顯示記憶體
        logging_steps = 1,
