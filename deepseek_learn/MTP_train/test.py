...
input_ids = tokenizer.apply_chat_template([{"role": "user", "content": "寶寶生下來很可愛，但是覺得嘴唇發紫，而且心跳的也很慢，新生兒心率多少正常？"}], tokenize=True, return_tensors='pt', add_generation_prompt=True)
